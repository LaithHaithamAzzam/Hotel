                 ...
                 children: [
                   ...
                   Padding(
                     ...
                     child: Align(
                         ...
                         child: Text("LAITH HAITHAM AZZAM" , style: TextStyle(color: Colors.white , fontSize: MediaQuery.of(context).size.width * 0.037),)),
                   ),
                   Padding(
                     ...
                     child: Align(
                         ...
                         heightFactor: 2,
                         child: Text("18,000.000 SP" , style: TextStyle(color: Colors.white , fontSize: MediaQuery.of(context).size.width * 0.037),)),
                   ),
                 ],
               ),
             ) ,
