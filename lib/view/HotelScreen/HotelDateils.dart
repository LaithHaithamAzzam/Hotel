...
class _HotelDetailsState extends State<HotelDetails> {
  ...
  return MaterialButtonCustom(
                ...
                onpressed: ()async {
                 await CreateHotelAccount(context).createHotelAccount("${Prov.hotelname}","${Prov.username}","${Prov.password}",int.parse((Provider.of<LocationProvider>(context,listen: false).Locid).toString()),int.parse(roomcounter.text),double.parse(minimumPrice.text),"${LocationDescription.text}","${Description.text}","sweet", Provider.of<Imageprovider>(context,
                     listen: false)
                     .image!);
                 },
