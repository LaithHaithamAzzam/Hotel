...
import 'package:hotel/controller/UpdateLocationDetails.dart';
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      TextButtonforHotel(onpressed: () async {
                        detailcon.text.isNotEmpty ? await UpdateLocationDetails(context).updateLocationDetails(detailcon.text):null;
                      },
