...
class Textfromfild extends StatelessWidget {
   Textfromfild({required this.suffixicon,required this.prefixicon,required this.controllertxt,required this.hinttext,required this.txtInputType,super.key});
   Widget suffixicon;
   Widget prefixicon;
